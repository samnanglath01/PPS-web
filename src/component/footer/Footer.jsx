        ...
        <div  className="d-flex flex-column footer w-100 gap-3">
            ...
            <div className="row bottom d-flex justify-content-between">
                ...
                <div className='social d-flex col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6'>
                    <a href="https://www.linkedin.com/company/paris-partners-softwares/about/" target='_blank' rel="noreferrer"><i class="fa-brands fa-linkedin"></i></a>
                    <a href="https://web.facebook.com/paris.partners.softwares/?_rdc=1&_rdr" target='_blank' rel="noreferrer"><i class="fa-brands fa-facebook"></i></a>
                    <a href="https://www.allweb.com.kh" target='_blank' rel="noreferrer"><i class="fa-brands fa-twitter"></i></a>
                </div>
